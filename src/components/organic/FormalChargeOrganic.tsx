...
const PROBLEMS: FCProblem[] = [
  {
    species: 'Carbocation', formula: 'R₃C⁺', targetAtom: 'carbon (sp²)',
  ...
  {
    species: 'Carbanion', formula: 'R₃C⁻', targetAtom: 'carbon (with lone pair)',
  ...
  {
    species: 'Water', formula: 'H₂O', targetAtom: 'oxygen',
  ...
  {
    species: 'Oxocarbenium ion', formula: 'R₂C=O⁺R′', targetAtom: 'oxygen (one lone pair)',
  ...
  {
    species: 'Carboxylate anion (one resonance form)', formula: 'RCOO⁻ (C=O side)', targetAtom: 'singly-bonded oxygen (O⁻)',
  ...
  {
    species: 'Ammonium ion', formula: 'NH₄⁺', targetAtom: 'nitrogen',
  ...
  {
    species: 'Nitro group (–NO₂)', formula: 'R–N⁺(=O)(O⁻)', targetAtom: 'nitrogen',
    valence: 5, lonePairs: 0, bonds: 4,
    correct: calcFC(5, 0, 4),
  ...
  {
    species: 'Acylium ion', formula: 'RC≡O⁺', targetAtom: 'oxygen',
    valence: 6, lonePairs: 2, bonds: 3,
    correct: calcFC(6, 2, 3),
  ...
  {
    species: 'Enolate (C-form)', formula: '⁻CH₂–C(=O)–R', targetAtom: 'α-carbon (C⁻)',
    valence: 4, lonePairs: 2, bonds: 3,
    correct: calcFC(4, 2, 3),
  ...
  {
    species: 'Diazonium ion', formula: 'ArN₂⁺', targetAtom: 'terminal nitrogen (≡N)',
