...
const PROBLEMS: MCProblem[] = [
  // ── Classify the diene ──────────────────────────────────────────────────
  {
    ...
    choices: [{ label: 'Conjugated' }, { label: 'Isolated' }, { label: 'Cumulated' }],
    answer: 'Conjugated',
  ...
  // ── s-cis vs s-trans ────────────────────────────────────────────────────
  {
    ...
    choices: [{ label: 's-cis' }, { label: 's-trans' }, { label: 'Either works' }],
    answer: 's-cis',
  ...
  },
  {
    ...
    choices: [{ label: 's-trans' }, { label: 's-cis' }, { label: 'They are equally stable' }],
    answer: 's-trans',
  ...
  },
  {
    ...
    choices: [
      { label: 'It cannot adopt s-cis conformation due to steric clash' },
      { label: 'It is an isolated diene' },
      { label: 'It has no HOMO electrons' },
    ],
  ...
  // ── 1,2 vs 1,4 addition ─────────────────────────────────────────────────
  {
    ...
    choices: [
      { label: '3-bromo-1-butene (1,2-product)' },
      { label: '1-bromo-2-butene (1,4-product)' },
    ],
  ...
  },
  {
    ...
    choices: [
      { label: 'Delocalized over C2–C3–C4 (resonance-stabilized)' },
      { label: 'Localized on C2 only' },
      { label: 'Localized on C4 only' },
    ],
  ...
  // ── Stability and conjugation ───────────────────────────────────────────
  {
    ...
    choices: [
      { label: 'Lower energy (extra stabilization from conjugation)' },
      { label: 'Higher energy (strain from conjugation)' },
      { label: 'The same energy' },
    ],
  ...
  },
  {
    ...
    choices: [
      { label: 'Conjugated diene absorbs at longer wavelength (lower energy)' },
      { label: 'Isolated diene absorbs at longer wavelength' },
      { label: 'Both absorb at the same wavelength' },
    ],
  ...
  // ── Diels-Alder basics ──────────────────────────────────────────────────
  {
    ...
    choices: [{ label: '4 electrons' }, { label: '2 electrons' }, { label: '6 electrons' }],
    answer: '4 electrons',
  ...
  },
  {
    ...
    choices: [
      { label: 'Electron-rich diene + electron-poor dienophile' },
      { label: 'Electron-poor diene + electron-poor dienophile' },
      { label: 'Electron-rich diene + electron-rich dienophile' },
    ],
...
export default function ConjugatedDienePractice({ allowCustom = true }: Props) {
  void allowCustom
  const [problem, setProblem] = useState<MCProblem & { shuffled: RenderableChoice[] }>(() => {
    const p = pick()
