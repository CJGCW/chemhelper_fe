...
const AMINO_ACIDS: AminoAcid[] = [
  // Nonpolar / aliphatic
  { name: 'Glycine',       three: 'Gly', one: 'G', rGroup: 'H',                   class: 'nonpolar', pKa1: 2.34, pKa2: 9.60,                pI: 5.97 },
  { name: 'Alanine',       three: 'Ala', one: 'A', rGroup: 'CH₃',                 class: 'nonpolar', pKa1: 2.34, pKa2: 9.69,                pI: 6.00 },
  { name: 'Valine',        three: 'Val', one: 'V', rGroup: 'CH(CH₃)₂',            class: 'nonpolar', pKa1: 2.32, pKa2: 9.62,                pI: 5.96 },
  { name: 'Leucine',       three: 'Leu', one: 'L', rGroup: 'CH₂CH(CH₃)₂',        class: 'nonpolar', pKa1: 2.36, pKa2: 9.60,                pI: 5.98 },
  { name: 'Isoleucine',    three: 'Ile', one: 'I', rGroup: 'CH(CH₃)CH₂CH₃',      class: 'nonpolar', pKa1: 2.36, pKa2: 9.60,                pI: 6.02 },
  ...
  { name: 'Methionine',    three: 'Met', one: 'M', rGroup: 'CH₂CH₂SCH₃',         class: 'nonpolar', pKa1: 2.28, pKa2: 9.21,                pI: 5.74 },
  // Aromatic
  ...
  // Polar uncharged
  { name: 'Serine',        three: 'Ser', one: 'S', rGroup: 'CH₂OH',              class: 'polar',    pKa1: 2.21, pKa2: 9.15,                pI: 5.68 },
  { name: 'Threonine',     three: 'Thr', one: 'T', rGroup: 'CH(OH)CH₃',          class: 'polar',    pKa1: 2.11, pKa2: 9.62,                pI: 5.87 },
  { name: 'Cysteine',      three: 'Cys', one: 'C', rGroup: 'CH₂SH',              class: 'polar',    pKa1: 1.96, pKa2: 8.18,  pKaR: 8.30,  pI: 5.07, notes: 'Forms disulfide bonds (Cys-S-S-Cys) critical for protein structure' },
  { name: 'Asparagine',    three: 'Asn', one: 'N', rGroup: 'CH₂CONH₂',           class: 'polar',    pKa1: 2.02, pKa2: 8.80,                pI: 5.41 },
  { name: 'Glutamine',     three: 'Gln', one: 'Q', rGroup: 'CH₂CH₂CONH₂',       class: 'polar',    pKa1: 2.17, pKa2: 9.13,                pI: 5.65 },
  // Acidic
  { name: 'Aspartate',     three: 'Asp', one: 'D', rGroup: 'CH₂COOH',            class: 'acidic',   pKa1: 1.88, pKa2: 9.60,  pKaR: 3.65,  pI: 2.77 },
  { name: 'Glutamate',     three: 'Glu', one: 'E', rGroup: 'CH₂CH₂COOH',        class: 'acidic',   pKa1: 2.19, pKa2: 9.67,  pKaR: 4.25,  pI: 3.22 },
  // Basic
  { name: 'Lysine',        three: 'Lys', one: 'K', rGroup: '(CH₂)₄NH₂',          class: 'basic',    pKa1: 2.18, pKa2: 8.95,  pKaR: 10.50, pI: 9.74 },
          ...
          <tbody>
            {filtered.map(aa => (
              <tr key={aa.name} className="border-b border-border/50 hover:bg-raised/50 transition-colors">
                ...
                <td className="py-2 pr-3 font-mono text-secondary">{aa.rGroup}</td>
