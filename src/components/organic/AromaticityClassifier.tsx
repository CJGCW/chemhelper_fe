  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div className="p-3 rounded-sm border border-border bg-surface text-sm font-sans text-secondary flex flex-col gap-1">
        ...
        <p><span className="text-success font-semibold">Aromatic:</span> cyclic + planar + conjugated + 4n+2 π electrons</p>
        <p><span className="text-error font-semibold">Antiaromatic:</span> cyclic + planar + conjugated + 4n π electrons</p>
