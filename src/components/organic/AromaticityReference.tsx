        ...
        <div className="p-4 rounded-sm border border-border bg-surface flex flex-col gap-3">
          ...
          <div className="grid grid-cols-3 gap-3 font-mono text-sm">
            {[
              ...
              <div key={row.n} className="flex items-center gap-2 px-3 py-2 rounded-sm border border-emerald-800/40 bg-emerald-950/20">
                <span className="text-dim">n={row.n}:</span>
                <span className="text-emerald-400 font-bold">{row.count}π</span>
              </div>
            ))}
          </div>
            ...
            <tbody className="text-secondary text-sm">
              {[
                ...
                <tr key={sys} className="border-b border-border/50">
                  ...
                  <td className="py-1.5 pr-4 text-center text-emerald-400">{pi}</td>
          ...
          <table className="font-mono text-xs border-collapse w-full">
            ...
            <tbody className="text-secondary text-sm">
              {[
                ...
                <tr key={sys} className="border-b border-border/50">
                  <td className="py-1.5 pr-4 text-primary">{sys}</td>
                  <td className="py-1.5 pr-4 text-center text-rose-400">{pi}</td>
                  <td className="py-1.5 text-dim text-[11px]">{note}</td>
                </tr>
              ))}
            </tbody>
