...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    newman: { front: ['H', 'H', 'H'], back: ['H', 'H', 'H'], dihedral: 60 },
    options: [
      'The staggered conformation (φ = 60°)',
      'The eclipsed conformation (φ = 0°)',
      'Both are equally stable for propane',
      'Propane does not have staggered conformations',
    ],
