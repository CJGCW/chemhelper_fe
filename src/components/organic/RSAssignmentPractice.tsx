...
const PROBLEMS: RSProblem[] = [
  {
    description: '2-Bromobutane: C2 bonded to Br (front), CH₂CH₃ (wedge), CH₃ (dash), H (back)',
  ...
  {
    description: '2-Chloro-1-propanol: C2 bonded to OH, Cl, CH₃, H (with H pointing away)',
  ...
  {
    description: 'Glyceraldehyde (D-): central C bonded to OH (right, equatorial), CHO (top), CH₂OH (bottom), H (left, into page)',
  ...
  {
    description: '1-Bromo-1-fluoroethane: C1 bonded to Br, F, CH₃, H (H points away)',
