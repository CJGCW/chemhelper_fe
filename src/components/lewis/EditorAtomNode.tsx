...
const ELEM_COLORS: Record<string, string> = {
  ...
  C:  '#e2e8f0',
  N:  '#6ea8fe',
  O:  'rgb(var(--color-error))',
  F:  'rgb(var(--color-success))',
  Cl: 'rgb(var(--color-success))',
  Br: 'rgb(var(--color-warning))',
  I:  '#c084fc',
  S:  '#fbbf24',
  P:  'rgb(var(--color-warning))',
  Na: '#a78bfa',
  K:  '#818cf8',
  Li: '#c084fc',
  Ca: '#94a3b8',
  Mg: 'rgb(var(--color-success-strong))',
  Al: '#94a3b8',
  Si: '#a8a29e',
  Fe: '#c07040',
  Cu: '#c88050',
  Zn: '#7080b0',
  B:  'rgb(var(--color-warning))',
  Xe: '#60a5fa',
  Kr: '#818cf8',
}
