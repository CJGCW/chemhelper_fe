              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  <button onClick={() => handleSelfAssess(true)}
                    className="px-4 py-1.5 rounded-sm font-sans text-sm font-medium border border-emerald-500 dark:border-emerald-700/50 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:bg-emerald-950/20 transition-colors">
                    Yes, correct
                  </button>
                  <button onClick={() => handleSelfAssess(false)}
                    className="px-4 py-1.5 rounded-sm font-sans text-sm font-medium border border-rose-500 dark:border-rose-700/50 text-rose-700 dark:text-rose-400 hover:bg-rose-50 dark:bg-rose-950/20 transition-colors">
                    No, incorrect
                  </button>
                </div>
              </div>
