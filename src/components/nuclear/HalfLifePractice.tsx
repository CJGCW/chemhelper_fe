...
import {
  generateHalfLifeProblem, checkHalfLifeAnswer, type HalfLifeProblem,
...
export default function HalfLifePractice({ allowCustom = true }: Props) {
  const [problem, setProblem] = useState<HalfLifeProblem>(generateHalfLifeProblem)
  ...
  function handleCheck() {
    ...
    const correct = checkHalfLifeAnswer(answer, problem)
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <p className="font-sans text-sm text-secondary leading-relaxed">
        Apply half-life equations: <span className="font-mono text-primary">N = N₀ × (1/2)^(t/t½)</span>.
