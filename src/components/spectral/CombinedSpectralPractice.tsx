              ...
              <AnimatePresence>
                {checked && (
                  <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
                    className={`rounded-sm border px-4 py-3 flex flex-col gap-3 font-sans text-sm font-semibold ${correct ? 'text-emerald-700 dark:text-emerald-400 border-emerald-500/30' : 'text-red-400 border-red-500/30'}`}
