              ...
              {problem.choices.map(c => {
                ...
                return (
                  <button
                    ...
                    style={
                      isCorrectChoice
                        ? { background: 'rgb(var(--color-success) / 0.15)', border: '1px solid rgb(var(--color-success) / 0.5)', color: 'rgb(var(--color-success-strong))' }
                        : isWrongChoice
                        ? { background: 'rgb(var(--color-error) / 0.12)', border: '1px solid rgb(var(--color-error) / 0.4)', color: 'rgb(var(--color-error-strong))' }
                        : isSelected && !checked
